...
train <-read.csv(file = "C:/Users/Ekaterina Huster/Documents/Katya/Documents/R/predictwR/pml-training.csv", head = T, na.strings =  c("#DIV/0!", "", " ", "NA"))
test <- read.csv(file = "C:/Users/Ekaterina Huster/Documents/Katya/Documents/R/predictwR/pml-testing.csv", head = T, na.strings = c("#DIV/0!", "", " ", "NA"))
```
```{r}
library(caret)
library(rpart.plot)
...
####Conclusion
THe completed project showed that random forest is far more superior than Decision Trees model. However, it is also very computationally intence.
